  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        outdoor: {
          DEFAULT: "hsl(var(--outdoor))",
          light: "hsl(var(--outdoor-light))",
        },
        entertainment: {
          DEFAULT: "hsl(var(--entertainment))",
          light: "hsl(var(--entertainment-light))",
        },
        relax: {
        ...
        theme: {
          lazy: "hsl(var(--theme-lazy))",
          adventurous: "hsl(var(--theme-adventurous))",
          family: "hsl(var(--theme-family))",
        },
        sidebar: {
